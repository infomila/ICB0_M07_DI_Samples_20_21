...
{
    public class UIEditorPersonaViewModel : INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;

        private Persona laPersonaAEditar;

        public UIEditorPersonaViewModel_Persona LaPersona { get; set; } // aquesta persona té els seus camps actualitzats gràcies al Binding bidireccional

        public UIEditorPersonaViewModel(Persona laPersonaAEditar)
        {
            this.laPersonaAEditar = laPersonaAEditar;
            //----------------------------------------------
            LaPersona = new UIEditorPersonaViewModel_Persona();
