...
namespace _20211125_DemoSqlite
{
    ...
    sealed partial class App : Application
    {
        ...
        private async System.Threading.Tasks.Task InicialitzaBDAsync()
        {
            ...
            try
            {
                string name = MyDBContext.DB_FILENAME;
                var dbFolderAppData = ApplicationData.Current.LocalFolder;
                StorageFolder dbFolder = await dbFolderAppData.CreateFolderAsync(MyDBContext.DB_PATH, CreationCollisionOption.OpenIfExists);
                ...
                catch (FileNotFoundException ex)
                {
                    ...
                    // des d'Assets
                    var uriArxiuBDAAssets = new Uri($"ms-appx:///Assets/{MyDBContext.DB_PATH}/{name}");
